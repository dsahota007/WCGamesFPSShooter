...
public class ResurrectPerk : MonoBehaviour
{
    public PointManager points;
    [Header("Interact")]
    public Transform player;
    public PerkType type = PerkType.Resurrect;
    ...
    [HideInInspector] public bool hasResurrectPerk = false;
